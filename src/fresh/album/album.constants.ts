...
const BATTLE_MODE_PAGE_SPREADS: AlbumPageSpread[] = [
  ...
  },
  {
    ...
    leftRevealPuzzleId: 'battleTodd',
    rightRevealPuzzleId: 'battleTodd',
    leftSlots: [],
    rightSlots: [],
  },
  {
    id: 'battle-mode-story-marie',
    leftPageSource: require('../../../assets/albumgeneralstuff/albumbooks/battle_mode_full_pages_not_puzzle/battle_mode_full_pages/frag2.png'),
    leftRevealPuzzleId: 'battleNico',
    leftSlots: [],
    rightSlots: [],
  },
];
